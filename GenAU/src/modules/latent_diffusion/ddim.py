...
class DDIMSampler(object):
    ...
    def make_schedule(
        ...
        # TODO: test removing betas (it is not being used anywhere)
    ...
    def ddim_sampling(
        ...
        for i, step in enumerate(iterator):
            ...
            if backbone_type.lower() == 'fit':
                ...
                img, pred_x0, prev_iter_model_out = outs
            else:
                outs = self.p_sample_ddim(
                    img,
                    cond,
    ...
    def p_sample_ddim(
        ...
        **kwargs,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0:
            model_output = self.model.apply_model(x, t, c, return_model_out=return_model_out, **kwargs)

            if return_model_out:
                model_output, model_log = model_output
            ...
            model_uncond = self.model.apply_model(
                x_in, t_in, unconditional_conditioning,  return_model_out=return_model_out, **kwargs)
            model_t = self.model.apply_model(x_in, t_in, c, return_model_out=return_model_out, **kwargs,)

            if return_model_out:
                model_uncond, _ = model_uncond
                model_t, model_log = model_t
        ...
        if return_model_out:
            return x_prev, pred_x0, model_log
