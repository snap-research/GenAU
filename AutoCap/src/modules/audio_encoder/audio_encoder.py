...
from src.modules.audio_encoder.cnns import Cnn10, Cnn14, ResNet38
from src.modules.audio_encoder.htsat import HTSAT_Swin_Transformer
...
class AudioEncoderModel(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.model_arch == "cnn":
            ...
            if config.pretrained:
                htsat_checkpoint_path = get_checkpoint_path('HTSAT', download=True)
                audio_ckpt = torch.load(htsat_checkpoint_path, map_location="cpu")["state_dict"]
